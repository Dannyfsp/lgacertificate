export const successfulApplicationTemp = async (name: string, applicationId: string) => {
  const html = `
  <!DOCTYPE html>
  <html lang="en">
  <head>
                  ...
                  <table role="presentation" style="width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); border-collapse: collapse;">
                      ...
                      <tr>
                          <td style="background: linear-gradient(135deg, #1a7f3e 0%, #0d5f2e 100%); padding: 40px 30px; text-align: center; border-radius: 8px 8px 0 0; border-top: 4px solid #d4af37;">
                              ...
                              <h1 style="margin: 0; color: #ffffff; font-size: 28px; font-weight: 600;">Application Submitted!</h1>
                      ...
                      <tr>
                          <td style="padding: 0 30px 30px;">
                              ...
                              <p style="color: #666666; font-size: 16px; line-height: 1.6; margin: 0 0 20px;">
                                  Thank you for submitting your application for <strong>LGA Certificate</strong>. We've successfully received your application and it's now under review.
                              </p>
                                          ...
                                          <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                              ...
                                              <tr>
                                                  ...
                                                  <td style="padding: 8px 0; text-align: right;">
                                                      <span style="display: inline-block; padding: 4px 12px; background-color: #fff4d4; color: #856404; border-radius: 12px; font-size: 13px; font-weight: 600;">Under Review</span>
                                                  </td>
                                              </tr>
                                          </table>
                                      </td>
                                  ...
                                  <tr>
                                      <td style="padding: 20px;">
                                          ...
                                          <p style="color: #0d5f2e; font-size: 14px; line-height: 1.6; margin: 0;">
                                              Our team will review your application within <strong>2 hours</strong>. You'll receive an email notification once your application has been processed. You can track your application status anytime using your Application ID.
                                          </p>
                                      </td>
                                  </tr>
                              </table>
