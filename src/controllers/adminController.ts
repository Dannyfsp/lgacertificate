...
export const adminSignup = async (req: Request, res: Response) => {
  try {
    ...
    return successResponse(res,  "Invitation Email sent to admin successfully", {adminId: admin._id})
  } catch (err: any) {
...
// RESEND OTP
export const adminChangePassword = async (req: AuthenticatedRequest, res: Response) => {
  try {
